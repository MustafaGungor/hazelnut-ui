...
import {Panel,Store} from "hazelnut-ui";
    ...
    getProperties(){
        return <div>
            ...
            * Store için <b>data</b> ya da <b>url</b> zorunludur.<br/>
            ...
            '   url: \'localhost:5522/mg-rest/apiUrl\'\n' +
            '});'}</Highlight>
            ...
            * Store için <b>processor</b> ve <b>method</b> mg.io için yapılan processor ve ilgili method ismini çağırır.<br/>
