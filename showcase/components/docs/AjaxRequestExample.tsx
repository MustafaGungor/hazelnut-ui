...
import {Panel,AjaxRequest} from "hazelnut-ui";
...
export default class AjaxRequestExample extends React.Component<any,any>{
    ...
    getAjaxRequest(){
        return <div>
            ...
            &emsp;AjaxRequest componenti <b>method</b> ve <b>processor</b> özellikleri mg-io için özel olarak yapılmıştır ve sunucu'da
