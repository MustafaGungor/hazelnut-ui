...
import {Button,I18n} from "hazelnut-ui";
        ...
        return <div>
            <div className="header">
                ...
                <Container className="slide-title">
                    <h3>HAZELNUT UI {I18n.message("home.message")}</h3>
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            <pre><code className="hljs"><span className="hljs-keyword">npm install</span> --save <span className="hljs-string">hazelnut-ui</span></code></pre>
                            <p>{I18n.message("or")}</p>
                            <pre><code className="hljs"><span className="hljs-keyword">yarn</span> add <span className="hljs-string">hazelnut-ui</span></code></pre>
                            ...
                            'import { Button } from \'hazelnut-ui\';\n' +
                            '\n' +
