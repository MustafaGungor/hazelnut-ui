...
import {FaIcon,I18n} from "hazelnut-ui";
                        ...
                        <Navbar className={`main-menu ${(window.location.hash == "#/")?"active-menu":""}`} expand="md">
                            <div className="header-logo">
                                <a href="#" className="logo-img">
                                    <img src={`./img/cover.png`} height="55" />
                                </a>
                            ...
                            <Collapse isOpen={this.state.isOpen} navbar>
                                <Nav className="ml-auto" navbar>
                                    ...
                                    <NavItem>
                                        <NavLink href="https://github.com/mustafagungor/hazelnut-ui">Github</NavLink>
                                    </NavItem>
                            ...
                            <Container>
                                <Row>
                                    <Col className="footer-left">
                                        <iframe src="https://ghbtns.com/github-btn.html?user=mustafagungor&amp;repo=hazelnut-ui&amp;type=star&amp;count=true" scrolling="0" width="100" height="20px"></iframe>
                                        <iframe src="https://ghbtns.com/github-btn.html?user=mustafagungor&amp;repo=hazelnut-ui&amp;type=fork&amp;count=true" scrolling="0" width="100" height="20px"></iframe>
                                    </Col>
                                    <Col className="footer-right"><img src="./img/default.png" height="65" /></Col>
                                </Row>
                            </Container>
                        </div>
                    </div>
