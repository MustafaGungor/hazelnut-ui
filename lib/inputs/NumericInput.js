...
var NumericInput = /** @class */ (function (_super) {
    ...
    NumericInput.prototype.render = function () {
        ...
        var label = this.props.label != null ? React.createElement(reactstrap_1.Label, { className: "label-properties inputtitle" }, this.props.label) : "";
        return React.createElement("div", { className: "mg-input" },
            label,
