...
var SelectInput = /** @class */ (function (_super) {
        ...
        if (_this.props.type === 'multi') {
            window.addEventListener('click', function (event) {
                ...
                event.path.forEach(function (value) {
                    if (value.className !== undefined && value.className !== "" && value.className.indexOf("mg-select-input") !== -1 && value.className.indexOf('select-' + _this.state.randomId) !== -1) {
                        control = true;
                    }
                });
                if (!control) {
    ...
    SelectInput.prototype.render = function () {
        ...
        return React.createElement("div", { className: "mg-select-input select-" + this.state.randomId + " mg-input", onClick: function () { if (_this.props.type !== "single") {
                _this.inputFocus();
            } } },
    ...
    SelectInput.prototype.singleSelectResult = function () {
        ...
        return React.createElement("select", { className: "form-control mg-select " + this.props.className, value: activeId, name: this.props.name, onChange: function (e) {
