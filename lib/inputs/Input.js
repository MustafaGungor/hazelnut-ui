...
var Input = /** @class */ (function (_super) {
    ...
    Input.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({}, labelOption, { className: "mg-input " + this.props.type + "-input " + this.props.className + ' ' + labelPositionClass + (this.props.icon ? ' left-icon' : '') }),
            ...
            case 'radio':
                if (this.props.checkItems.length === 0) {
                    ...
                    this.props.checkItems.forEach(function (value, index) {
                        var sendCheckProps = __rest(__assign(__assign({}, value), generalInput), []);
    ...
    Input.prototype.getCheck = function (inputClass, inputProps, index) {
        var _this = this;
        return React.createElement("label", { className: inputClass + " " + this.props.type + "-item inputtitle" },
