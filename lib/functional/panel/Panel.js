    ...
    Panel.prototype.render = function () {
        ...
        if (this.state.accordion) {
            ...
            if (this.props.title !== undefined && this.props.title !== "") {
                panelTitle = React.createElement("div", { className: "panel-title", onClick: function () { if (_this.props.onClick) {
                        _this.props.onClick();
                    }
                    else {
                        _this.openPanel();
                    } } },
                    (this.props.icon !== undefined) ? React.createElement(FaIcon_1.default, { code: this.props.icon }) : '',
                    " ",
                    React.createElement("span", null, this.props.title),
                    openButton);
            }
