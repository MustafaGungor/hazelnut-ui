...
var ContextMenu = /** @class */ (function (_super) {
    ...
    ContextMenu.prototype.render = function () {
        return React.createElement("div", { className: "mg-context-menu " + ((this.state.showContext.control) ? 'active' : ''), style: { top: this.state.eventDirection.y, left: this.state.eventDirection.x } },
    ...
    ContextMenu.prototype.pathControl = function (event) {
        ...
        event.path.forEach(function (val) {
            if (val.className !== undefined && val.className !== "" && val.className.indexOf('mg-context-menu') !== -1) {
                control = true;
            }
        });
        if (!control) {
